 ...
 *   Issue this scope to read-only consumers (dashboards, CI log viewers, etc.)
 *   that must not have ingest capability. Ingest+read keys should carry both.
 */
...
export const createApiKeyRequestSchema = z
  .object({
    ...
    // Read-only consumers should explicitly request ['logs:read'].
